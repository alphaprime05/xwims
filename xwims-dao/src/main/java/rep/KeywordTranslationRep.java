...
public class KeywordTranslationRep {
	...
	public KeywordTranslationRep(KeywordTranslation keywordTranslation, int nbVote, boolean hasUserVoted) {
		this.id = keywordTranslation.getId();
		this.xwims_translation = keywordTranslation.getXwimsTranslation();
		this.nbVote = nbVote;
	...
	public String toString() {
		return "KeywordTranslationRep [id=" + id + ", xwims_translation=" + xwims_translation + ", nbVote=" + nbVote
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		KeywordTranslationRep other = (KeywordTranslationRep) obj;
